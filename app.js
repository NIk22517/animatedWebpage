...
function animateSlides(){
    ...
    sliders.forEach((slide,index,slides)=>{
        ...
        slideTl.fromTo('.nav-header',1,{y:'-100%'},{y:'0% ' ,ease: "power2.inOut"});
        //Create a Scene
        ...
        .setTween(slideTl)//to activevate the img scroll
...
function detailAnimation(){
    ...
    slides.forEach((slide,index,slides) =>{
        const slideTl = gsap.timeline({defaults: {ease: 'power2.inOut'}});
        let nextSlide  = slides.length - 1 === index ? 'end' : slides[index + 1];
